...
cmd="cmake -H$root -B$root/_build $gen_arg -DCMAKE_EXPORT_COMPILE_COMMANDS=1 -DCMAKE_INSTALL_PREFIX=$root/_install -DCMAKE_BUILD_TYPE=\"$build\" -DBUILD_SHARED_LIBS=\"$shared\" -Wno-dev"
sh -c "$cmd"
